        ...
        renderItem={({ item }) => (
          <Card style={styles.orderCard}>
            <View style={styles.orderHeader}>
              ...
              <View style={[styles.badge, { backgroundColor: statusColors[item.status] || colors.muted }]}>
...
const styles = StyleSheet.create({
  ...
  badgeText: { fontSize: fontSize.xs, fontWeight: '600', color: colors.bg, textTransform: 'uppercase' },
  orderTotal: { fontSize: fontSize.lg, fontWeight: '700', color: colors.accent },
});
